<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <div class="list-group list-group-flush">
	...
	<a class="list-group-item list-group-item-action list-group-item-light p-3" href="${pageContext.request.contextPath }/main.do">홈</a>
	
	<c:choose>
		<c:when test="${sessionId == null}">
		<a class="list-group-item list-group-item-action list-group-item-light p-3" href="${pageContext.request.contextPath }/loginForm.do">로그인</a>	
		</c:when>
		...
		<a class="list-group-item list-group-item-action list-group-item-light p-3" href="${pageContext.request.contextPath }/.do">마이페이지</a>
		</c:otherwise>
	</c:choose>
